...
is). Budget roughly $0.10/hr for the EKS control plane + a few cents/hr for
the NAT Gateway + LoadBalancer while resources are running. **Section 9
below tells you exactly how to delete everything.** Don't leave this running
overnight unless you intend to.
...
## 11. (Optional) Ingress via AWS Load Balancer Controller
...
## 12. Tear everything down (IMPORTANT — do this when you're done)
